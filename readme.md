...
```text
Signing:UpmServiceAccountKeyId
Signing:UpmServiceAccountKeySecret
Signing:UnityOrganizationId
```

If these variables are set, the packages will be signed automatically.
